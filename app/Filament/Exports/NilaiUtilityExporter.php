...
class NilaiUtilityExporter extends Exporter
{
    protected static ?string $model = NilaiUtility::class;
    ...
    {
        $body = 'Your nilai utility export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
